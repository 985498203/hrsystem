...
<title>用户登录</title>
<!-- Bootstrap core CSS -->
<link href="${base}/static/asserts/css/bootstrap.min.css" rel="stylesheet">
<!-- Custom styles for this template -->
<link href="${base}/static/asserts/css/signin.css" rel="stylesheet">
</head>
<body class="text-center">
	<form class="form-signin" method="post" action="/user/login.html">
		...
		<label class="sr-only">用户名</label> <input type="text"
			class="form-control" placeholder="用户名" name="username" required=""
			autofocus=""> <label class="sr-only">密码</label> <input
